...
- Der Haupt-Server läuft bereits (siehe [SELFHOSTING.md](SELFHOSTING.de.md)).
- S3-kompatibler externer Storage (kein MinIO-im-Docker, denn das wäre nur auf dem Haupt-Server). Siehe [STORAGE.md](STORAGE.de.md).
