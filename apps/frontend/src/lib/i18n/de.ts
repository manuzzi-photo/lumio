...
export const de: LocaleDict = {
  ...
  apiError: {
    ...
    pageSlugTaken: "Diese Seiten-URL ist bereits vergeben.",
    invalidPageSlug: "Diese Seiten-URL ist ungültig. Erlaubt sind Kleinbuchstaben, Zahlen und Bindestriche (3–60 Zeichen).",
    defaultPageMustBePublic: "Nur eine öffentliche Seite kann die Startseite sein.",
    pageFull: "Eine Seite fasst höchstens 200 Galerien.",
    alreadyOnPage: "Diese Galerie ist bereits auf der Seite.",
    galleryNotFound: "Galerie nicht gefunden.",
    invalidBranding: "Dieses Gestaltungsprofil gibt es nicht.",
    duplicateGallery: "Eine Galerie kommt in der Reihenfolge doppelt vor.",
    unknownGallery: "Die Reihenfolge enthält eine Galerie, die nicht auf dieser Seite ist.",
    passwordRequired: "Eine passwortgeschützte Seite braucht ein Passwort.",
    inUse:
  ...
  settings: {
    ...
    catalogFlagLandingPagesName: "Landing Pages",
  ...
  pages: {
    title: "Seiten",
    breadcrumb: "Seiten",
    description: "Kuratierte Seiten, die deine Galerien unter einem Link auflisten: ein Portfolio für alle oder eine Seite für einen einzelnen Kunden.",
    newPage: "Neue Seite",
    titlePlaceholder: "z.B. Portfolio oder Anna & Luca",
    titleLabel: "Titel",
    createHint: "Eine neue Seite ist nur über ihren Link erreichbar und wird nicht von Suchmaschinen indexiert. Wer sie öffnen darf, legst du später fest.",
    empty: "Noch keine Seiten.",
    createFirst: "Erste Seite anlegen",
    startPageBadge: "Startseite",
    forbidden: "Nur Owner und Admins können Seiten verwalten.",
    loadFailed: "Die Seite konnte nicht geladen werden.",
    saveFailed: "Speichern fehlgeschlagen. Bitte versuche es erneut.",
    visibleCountSg: "{visible} von {total} Galerie sichtbar",
    visibleCountPl: "{visible} von {total} Galerien sichtbar",
    editorDescription: "Lege fest, welche Galerien hier in welcher Reihenfolge erscheinen und wer die Seite öffnen darf.",
    openPage: "Seite öffnen",
    delete: "Seite löschen",
    deleteConfirmTitle: "„{title}“ löschen?",
    deleteConfirmMessage: "Die Galerien darauf bleiben unverändert. Wer den Link zu dieser Seite hat, kann sie nicht mehr öffnen.",
    deleteConfirmStart: "Das ist deine Startseite, unter {origin} erscheint danach wieder die Anmeldung. Die Galerien darauf bleiben unverändert.",
    detailsHeading: "Details",
    introLabel: "Einleitung",
    introHint: "Wird unter dem Titel angezeigt. Markdown wird unterstützt.",
    brandingLabel: "Gestaltung",
    brandingDefault: "Standard des Studios",
    brandingHint: "Logo, Farben und Schrift der Seite. Es gilt die Standard-Gestaltung deines Studios, solange du kein anderes Profil wählst.",
    addressHeading: "Seiten-URL",
    addressDesc: "Der Link zu dieser Seite.",
    addressStartPageNote: "Diese Seite ist deine Startseite und wird deshalb auch unter {origin} ausgeliefert.",
    addressWarnPre: "Nach einer Änderung funktioniert der bisherige Link",
    addressWarnPost: "nicht mehr. Bereits verschickte Links führen ins Leere.",
    copyLink: "Link kopieren",
    linkCopied: "Kopiert",
    accessHeading: "Wer diese Seite öffnen darf",
    access: {
      public: "Öffentlich",
      publicDesc: "Jeder kann sie öffnen und Suchmaschinen dürfen sie indexieren. Nur eine öffentliche Seite kann deine Startseite sein.",
      link_only: "Nur mit Link",
      link_onlyDesc: "Nur wer den Link hat. Nirgends aufgelistet und nicht von Suchmaschinen indexiert.",
      password: "Passwort",
      passwordDesc: "Nur wer den Link und das Passwort hat.",
    },
    passwordLabel: "Passwort",
    passwordKeep: "Leer lassen, um das aktuelle Passwort zu behalten",
    passwordNeeded: "Lege ein Passwort fest, um diese Seite zu schützen.",
    startPageLabel: "Als meine Startseite verwenden",
    startPageDesc: "Wird unter {origin} angezeigt, statt zur Anmeldung weiterzuleiten. Die Anmeldung bleibt unter /login und ist im Footer der Seite verlinkt.",
    startPageNeedsPublic: "Nur eine öffentliche Seite kann die Startseite sein.",
    confirmStartTitle: "Als Startseite festlegen?",
    confirmStartMessage: "Besucher von {origin} sehen diese Seite, statt zur Anmeldung weitergeleitet zu werden. Deine Anmeldung bleibt unter /login und ist im Footer der Seite verlinkt. Eine bereits vorhandene Startseite wird ersetzt.",
    confirmStartAction: "Als Startseite festlegen",
    confirmLeaveStartTitle: "Startseite aufgeben?",
    confirmLeaveStartMessage: "{origin} leitet danach wieder zur Anmeldung weiter.",
    confirmLeaveStartAction: "Speichern",
    galleriesHeading: "Galerien auf dieser Seite",
    galleriesDesc: "Zum Sortieren ziehen. Besucher sehen eine Galerie nur, solange sie aktiv und nicht abgelaufen ist und ohne Freigabe-Link geöffnet werden kann.",
    exposureWarning: "Cover, Beschreibungen und Foto-Anzahl von Galerien ohne Passwort sind für alle sichtbar, die diese Seite öffnen können. Galerien mit Passwort zeigen nur Titel, Datum und ein Schloss — es sei denn, du aktivierst unten die Vorschau für sie.",
    addGallery: "Galerie hinzufügen",
    noGalleries: "Noch keine Galerien auf dieser Seite.",
    dragHandle: "Zum Sortieren ziehen",
    badgeProtected: "Passwort",
    notShownDraft: "Nicht sichtbar: Entwurf",
    notShownArchived: "Nicht sichtbar: archiviert",
    notShownExpired: "Nicht sichtbar: abgelaufen",
    notShownLinksOnly: "Nicht sichtbar: braucht Freigabe-Link",
    filesSg: "{count} Datei",
    filesPl: "{count} Dateien",
    titleOnPage: "Titel auf dieser Seite (optional)",
    previewToggle: "Vorschau öffentlich zeigen",
    previewToggleHint: "Zeigt Cover, Beschreibung und Foto-Anzahl dieser passwortgeschützten Galerie allen, die die Seite öffnen können.",
    remove: "Entfernen",
    removeConfirm: "„{title}“ von dieser Seite entfernen? Die Galerie selbst wird nicht gelöscht.",
    addDialogTitle: "Galerien hinzufügen",
    searchPlaceholder: "Galerien suchen",
    noMatches: "Keine Galerien gefunden.",
    pageFull: "Eine Seite fasst höchstens {max} Galerien.",
    add: "Hinzufügen",
    alreadyAdded: "Hinzugefügt",
  },
  publicPage: {
    studioLogin: "Studio-Login",
    empty: "Zurzeit sind keine Galerien verfügbar.",
    notFound: "Diese Seite gibt es nicht.",
    unavailable: "Diese Seite ist derzeit nicht verfügbar.",
    protectedLabel: "Passwortgeschützt",
    locked: "Diese Seite ist passwortgeschützt.",
    open: "Seite öffnen",
  },
  galleryPages: {
    heading: "Seiten",
    desc: "Lege diese Galerie auf einer Seite ab, um sie zusammen mit anderen unter einem Link zu zeigen.",
    addButton: "Zu Seite hinzufügen…",
    onNone: "Noch auf keiner Seite.",
    onPages: "Erscheint auf:",
    newPage: "Neue Seite",
    newPagePlaceholder: "Titel einer neuen Seite",
    newPageHint: "Eine neue Seite ist nur über ihren Link erreichbar und wird nicht von Suchmaschinen indexiert.",
    noteNotLive: "Auf einer Seite werden nur aktive Galerien gezeigt. Diese erscheint dort wieder, sobald sie aktiv ist.",
    noteLinksOnly: "Diese Galerie lässt sich nur mit einem Freigabe-Link öffnen und wird deshalb auf keiner Seite gezeigt. Erlaube den Zugang über den Galerie-Link, um sie zu zeigen.",
    exposureOpen: "Auf einer Seite sind Cover, Beschreibung und Foto-Anzahl dieser Galerie für alle sichtbar, die die Seite öffnen können.",
    exposureProtected: "Diese Galerie hat ein Passwort. Auf einer Seite zeigt sie nur Titel, Datum und ein Schloss — es sei denn, du aktivierst ihre Vorschau in der Seite.",
    loadFailed: "Die Seiten konnten nicht geladen werden.",
    archiveTitle: "Galerie archivieren?",
    archiveMessage: "„{title}“ erscheint auf: {pages}.\n\nDurch das Archivieren wird sie dort ausgeblendet. Wenn du sie wieder aktivierst, ist sie wieder an ihrem Platz.",
    deleteNote: "Sie verschwindet außerdem von diesen Seiten: {pages}.",
  },
  brandingsList: {
    breadcrumbStudio: "Studio",
    breadcrumb: "Branding",
  ...
  orderDetail: {
    ...
    actReadyForPickup: "Abholbereit",
    actDelivered: "Zugestellt",
    actPickedUp: "Abgeholt",
    ...
    pickupNoAddress: "Abholung im Geschäft — keine Lieferadresse erhoben.",
    ...
    secChecklist: "Auftragsabwicklung",
    checklistOrdered: "Bestellt",
    checklistPrinting: "In Druck",
    checklistShipped: "Versendet",
    checklistReadyForPickup: "Abholbereit",
    checklistDelivered: "Zugestellt",
    checklistPickedUp: "Abgeholt",
    checklistMark: "Als erledigt markieren",
  },
  ...
  shipping: {
    ...
    isPickupLabel: "Abholung im Geschäft",
    isPickupHint:
