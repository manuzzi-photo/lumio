...
export const en = {
  ...
  apiError: {
    ...
    pageSlugTaken: "That page URL is already taken.",
    invalidPageSlug: "That page URL is not valid. Use lowercase letters, numbers and hyphens (3–60 characters).",
    defaultPageMustBePublic: "Only a public page can be the start page.",
    pageFull: "A page holds at most 200 galleries.",
    alreadyOnPage: "This gallery is already on the page.",
    galleryNotFound: "Gallery not found.",
    invalidBranding: "That design profile does not exist.",
    duplicateGallery: "A gallery appears twice in the order.",
    unknownGallery: "The order contains a gallery that is not on this page.",
    passwordRequired: "A password page needs a password.",
    inUse:
  ...
  settings: {
    ...
    catalogFlagLandingPagesDesc:
      "Curated pages with their own link that list several galleries; optionally the studio's start page at /.",
  ...
  pages: {
    title: "Pages",
    breadcrumb: "Pages",
    description: "Curated pages that list your galleries under one link: a portfolio for everyone, or a page for a single client.",
    newPage: "New page",
    titlePlaceholder: "e.g. Portfolio or Anna & Luca",
    titleLabel: "Title",
    createHint: "A new page is only reachable through its link and is not indexed by search engines. You decide later who can open it.",
    empty: "No pages yet.",
    createFirst: "Create your first page",
    startPageBadge: "Start page",
    forbidden: "Only owners and admins can manage pages.",
    loadFailed: "The page could not be loaded.",
    saveFailed: "Saving failed. Please try again.",
    visibleCountSg: "{visible} of {total} gallery visible",
    visibleCountPl: "{visible} of {total} galleries visible",
    editorDescription: "Choose which galleries appear here, in which order, and who can open the page.",
    openPage: "Open page",
    delete: "Delete page",
    deleteConfirmTitle: "Delete “{title}”?",
    deleteConfirmMessage: "The galleries on it are not affected. Anyone with the link to this page will no longer be able to open it.",
    deleteConfirmStart: "This is your start page, so {origin} will show the login page again. The galleries on it are not affected.",
    detailsHeading: "Details",
    introLabel: "Introduction",
    introHint: "Shown below the title. Markdown is supported.",
    brandingLabel: "Design",
    brandingDefault: "Studio default",
    brandingHint: "Logo, colours and font of the page. Uses your studio's default design unless you pick another profile.",
    addressHeading: "Page URL",
    addressDesc: "The link to this page.",
    addressStartPageNote: "This page is your start page, so it is also served at {origin}.",
    addressWarnPre: "After changing it, the previous link",
    addressWarnPost: "stops working. Links you already sent will lead nowhere.",
    copyLink: "Copy link",
    linkCopied: "Copied",
    accessHeading: "Who can open this page",
    access: {
      public: "Public",
      publicDesc: "Anyone can open it and search engines may index it. Only a public page can be your start page.",
      link_only: "Link only",
      link_onlyDesc: "Only people who have the link. Not listed anywhere and not indexed by search engines.",
      password: "Password",
      passwordDesc: "Only people who have the link and the password.",
    },
    passwordLabel: "Password",
    passwordKeep: "Leave empty to keep the current password",
    passwordNeeded: "Set a password to protect this page.",
    startPageLabel: "Use as my start page",
    startPageDesc: "Shown at {origin} instead of redirecting to the login. The login stays at /login and is linked in the page's footer.",
    startPageNeedsPublic: "Only a public page can be the start page.",
    confirmStartTitle: "Make this your start page?",
    confirmStartMessage: "Visitors of {origin} will see this page instead of being sent to the login. Your login stays at /login and is linked in the footer of the page. A start page you already have is replaced.",
    confirmStartAction: "Make start page",
    confirmLeaveStartTitle: "Give up the start page?",
    confirmLeaveStartMessage: "{origin} will redirect to the login again.",
    confirmLeaveStartAction: "Save",
    galleriesHeading: "Galleries on this page",
    galleriesDesc: "Drag to reorder. Visitors see a gallery only while it is live, not expired and can be opened without a share link.",
    exposureWarning: "Cover images, descriptions and photo counts of galleries without a password are visible to everyone who can open this page. Galleries with a password show only their title, date and a lock, unless you switch on the preview for them below.",
    addGallery: "Add gallery",
    noGalleries: "No galleries on this page yet.",
    dragHandle: "Drag to reorder",
    badgeProtected: "Password",
    notShownDraft: "Not shown: draft",
    notShownArchived: "Not shown: archived",
    notShownExpired: "Not shown: expired",
    notShownLinksOnly: "Not shown: needs a share link",
    filesSg: "{count} file",
    filesPl: "{count} files",
    titleOnPage: "Title on this page (optional)",
    previewToggle: "Show preview publicly",
    previewToggleHint: "Shows the cover, description and photo count of this password-protected gallery to everyone who can open the page.",
    remove: "Remove",
    removeConfirm: "Remove “{title}” from this page? The gallery itself is not deleted.",
    addDialogTitle: "Add galleries",
    searchPlaceholder: "Search galleries",
    noMatches: "No galleries found.",
    pageFull: "A page holds at most {max} galleries.",
    add: "Add",
    alreadyAdded: "Added",
  },
  publicPage: {
  ...
  galleryPages: {
    heading: "Pages",
    desc: "Put this gallery on a page to show it together with others under one link.",
    addButton: "Add to page…",
    onNone: "Not on any page yet.",
    onPages: "Appears on:",
    newPage: "New page",
    newPagePlaceholder: "Title of a new page",
    newPageHint: "A new page is only reachable through its link and is not indexed by search engines.",
    noteNotLive: "Only live galleries are shown on a page. This one appears there again as soon as it is live.",
    noteLinksOnly: "This gallery can only be opened with a share link, so it is not shown on any page. Allow access with the gallery link to show it.",
    exposureOpen: "On a page, this gallery's cover, description and photo count are visible to everyone who can open the page.",
    exposureProtected: "This gallery has a password. On a page it shows only its title, date and a lock, unless you switch on its preview in the page.",
    loadFailed: "The pages could not be loaded.",
    archiveTitle: "Archive this gallery?",
    archiveMessage: "“{title}” appears on: {pages}.\n\nArchiving hides it there. If you reactivate it, it returns to its place.",
    deleteNote: "It also disappears from these pages: {pages}.",
  },
  brandingsList: {
    breadcrumbStudio: "Studio",
    breadcrumb: "Branding",
  ...
  orderDetail: {
    ...
    actShipped: "Shipped",
    actReadyForPickup: "Ready for pickup",
    actDelivered: "Delivered",
    actPickedUp: "Picked up",
    actCancel: "Cancel",
    actRefund: "Refund",
    ...
    pickupNoAddress: "In-store pickup — no shipping address collected.",
    ...
    evShipped: "Shipped",
    evReadyForPickup: "Ready for pickup",
    evDelivered: "Delivered",
    evPickedUp: "Picked up",
    evCancel: "Cancelled",
    evRefund: "Refunded",
    evNote: "Note added",
    ...
    shipSubmit: "Ship",
    secChecklist: "Fulfillment",
    checklistOrdered: "Ordered",
    checklistPrinting: "Printing",
    checklistShipped: "Shipped",
    checklistReadyForPickup: "Ready for pickup",
    checklistDelivered: "Delivered",
    checklistPickedUp: "Picked up",
    checklistMark: "Mark done",
  },
